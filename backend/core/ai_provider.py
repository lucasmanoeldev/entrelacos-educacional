...
def generate_draft(parameters):
    ...
    prompt = (
        ...
        'Produza exatamente a quantidade solicitada em count. '
        'Este pode ser um trecho de uma atividade maior: offset indica quantas perguntas já foram geradas. '
        'Varie os subtemas, exemplos e enunciados conforme o trecho, sem reiniciar sempre com as mesmas perguntas. '
        'Cada pergunta deve ter quatro alternativas distintas e exatamente uma correta. Inclua uma explicação didática curta. '
